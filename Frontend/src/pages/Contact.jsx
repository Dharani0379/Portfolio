      ...
      <div className="flex-1 flex flex-col items-center px-6 py-12 text-white">
        ...
        <footer className="mt-12 w-full flex flex-col items-center gap-4 text-gray-400">
          <div className="flex flex-wrap gap-6 justify-center text-white text-lg">
            <a href="#" className="hover:text-blue-500 transition-colors"><Facebook size={24} /></a>
            <a href="#" className="hover:text-pink-500 transition-colors"><Instagram size={24} /></a>
            <a href="#" className="hover:text-green-400 transition-colors"><FaWhatsapp size={24} /></a>
            <a href="#" className="hover:text-blue-400 transition-colors"><Linkedin size={24} /></a>
            <a href="#" className="hover:text-gray-300 transition-colors"><Github size={24} /></a>
            <a href="mailto:your@email.com" className="hover:text-yellow-300 transition-colors"><Mail size={24} /></a>
            <a href="tel:+1234567890" className="hover:text-green-300 transition-colors"><Phone size={24} /></a>
          </div>
          <div className="text-sm flex items-center gap-2 mt-2">
            <Copyright size={14} />
            <span>2025 Dharani dharan. All rights reserved.</span>
          </div>
        </footer>
      </div>
    </div>
